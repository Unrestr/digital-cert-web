...
import com.greatmap.framework.commons.utils.Identities;
...
public class FileUtils extends org.apache.commons.io.FileUtils {
	 ...
	 * @return 如果删除成功，则返回true，否是返回false
	 */
	public static boolean delFile(List<File> files) {
		boolean flag = false;
		for(File file : files){
			if (file.isFile()) {
	 ...
	 * @return
     */
	public static String getFakeFileName(String originalName){
		String fakeName= Identities.uuid()+"."+StringUtils.substringAfterLast(originalName,".");
		return fakeName;
	}
	...
	private static FileItem createFileItem(String filePath)
	{
		...
		String textFieldName = filePath.substring(filePath.lastIndexOf("/") + 1);
		FileItem item = factory.createItem(textFieldName, "application/octet-stream", true, textFieldName);
